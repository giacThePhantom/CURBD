...
figure, subplot = plt.subplots(1, figsize = (12, 12))
...
$$J_{ij} \sim \mathcal{N}\left(0, \frac{1}{\sqrt{N_{in}}}\right)$$
...
figure, subplot = plt.subplots(1, 3, figsize = (12, 12))
figure.tight_layout()
...
figure, subplots = plt.subplots(1, 2, figsize = (12, 12))
figure.tight_layout()
...
def plot_region(data_params, data, region):
    figure, subplots = plt.subplots(1, 3, figsize = (12, 12))
    figure.tight_layout()
    subplots[0].pcolormesh(
            np.arange(0, data_params['sim_time'], data_params['dt']),
...
def plot_train_evolution(figure, subplots, chi2s, pvars, neuron_index, state, experimental_data, plots, sim_param):
    if not figure:
        plt.ion()
        figure, subplots = plt.subplots(2, 3, figsize = (12, 12))
...
figure, subplot = plt.subplots(len(regions), len(regions) , figsize = (12, 12))
...
figure, subplot = plt.subplots(1, 3, subplot_kw = {'projection' : '3d'}, figsize = (12, 12))
...
figure, subplot = plt.subplots(len(regions), len(regions), sharex = True, sharey = True, figsize = (12, 12))
